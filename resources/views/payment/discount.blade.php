                            ...
                            <table id="invoice-list" class="table dt-table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $discount->year }}</td>
                                        <td>{{ $discount->name }}</td>
                                        <td class="text-end">{{ number_format($discount->total) }}</td>
                                        <td class="text-center">
                                            <a class="btn btn-outline-secondary btn-sm btn-icon btn-rounded" href="/admin/potongan/{{ $discount->ids }}">
            ...
            buttons: [
                {
                    ...
                    action: function(e, dt, node, config ) {
                        window.location = '/admin/potongan/0';
                    }
                }
            ],
            "order": [[ 1, "asc" ]],
