            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0">
                ...
                <li class="nav-item dropdown notification-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                        <div class="drodpown-title message">
                            <h6 class="d-flex justify-content-between"><span class="align-self-center">Notifikasi</span> <span class="badge badge-secondary">16</span></h6>
                        </div>
                        ...
                        <div class="notification">
                            <div class="dropdown-item">
                                <div class="media server-log">
                                    ...
                                    <div class="media-body">
                                        <div class="data-info">
                                            <h6 class="">Data telah disimpan</h6>
                                            <p class="">45 data</p>
                                        </div>
                            ...
                            <div class="dropdown-item">
                                <div class="media file-upload">
                                    ...
                                    <div class="media-body">
                                        <div class="data-info">
                                            <h6 class="">Konfirmasi Pembayaran</h6>
                                            <p class="">13 pembayaran</p>
                                        </div>
                            ...
                            <div class="dropdown-item">
                                <div class="media ">
                                    ...
                                    <div class="media-body">
                                        <div class="data-info">
                                            <h6 class="">Segera Lengkapi Data</h6>
                                            <p class="">8 data</p>
                                        </div>
                ...
                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        ...
                        <div class="dropdown-item">
                            <a href="/pengguna">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> <span>Pengguna</span>
                            </a>
                        </div>
                        <div class="dropdown-item">
                            <a href="/lockscreen">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg> <span>Kunci Layar</span>
                            </a>
                        </div>
                        <div class="dropdown-item">
                            <a href="/logout">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu {{ $title == 'Beranda Akademis' || $title == 'Beranda Keuangan' ? 'active' : '' }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ $title == 'Beranda Akademis' || $title == 'Beranda Keuangan' ? 'show' : '' }}" id="beranda" data-bs-parent="#accordionExample">
                            ...
                            <li class="{{ $title == 'Beranda Keuangan' ? 'active' : '' }}">
                                <a href="/home"> Keuangan </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    @if (auth()->user()->role > 1)
                        <li class="menu menu-heading">
                            <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg><span>ADMINISTRASI</span></div>
                        </li>
                        ...
                        <li class="menu {{ $title == 'Data Pembayaran' || $title == 'Rekap Pembayaran' || $title == 'Data Tagihan' || $title == 'Data Potongan' || $title == 'Konfirmasi Pembayaran' ? 'active' : '' }}">
                            ...
                            <ul class="collapse submenu list-unstyled {{ $title == 'Data Pembayaran' || $title == 'Rekap Pembayaran' || $title == 'Data Tagihan' || $title == 'Data Potongan' || $title == 'Konfirmasi Pembayaran' ? 'show' : '' }}" id="pembayaran" data-bs-parent="#accordionExample">
                    ...
                    <li class="menu menu-heading">
                        <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg><span>ASSESSMENT</span></div>
                    </li>
                    ...
                    <li class="menu {{ $title == 'Data Pelajaran' || $title == 'Data Kompetensi' || $title == 'Data Nilai' || $title == 'Data Rapor' ? 'active' : '' }}">
                        <a href="#academic" data-bs-toggle="collapse" aria-expanded="{{ $title == 'Data Pelajaran' || $title == 'Data Kompetensi' || $title == 'Data Nilai' || $title == 'Data Rapor' ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled {{ $title == 'Data Pelajaran' || $title == 'Data Kompetensi' || $title == 'Data Nilai' || $title == 'Data Rapor' ? 'show' : '' }}" id="academic" data-bs-parent="#accordionExample">
                            <li class="{{ $title == 'Data Pelajaran' ? 'active' : '' }}">
                                <a href="/data/pelajaran"> Pelajaran </a>
                            </li>
                            <li class="{{ $title == 'Data Kompetensi' ? 'active' : '' }}">
                                <a href="/data/kompetensi"> Kompetensi </a>
                            </li>
                            <li class="{{ $title == 'Data Nilai' ? 'active' : '' }}">
                                <a href="/data/nilai"> Nilai </a>
                            </li>
                            <li class="{{ $title == 'Data Rapor' ? 'active' : '' }}">
                                <a href="/data/rapor"> Rapor </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu {{ $title == 'Data Project' || $title == 'Data Task' ? 'active' : '' }}">
                        <a href="#project" data-bs-toggle="collapse" aria-expanded="{{ $title == 'Data Project' || $title == 'Data Task' ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled {{ $title == 'Data Project' || $title == 'Data Task' ? 'show' : '' }}" id="project" data-bs-parent="#accordionExample">
                            <li class="{{ $title == 'Data Project' ? 'active' : '' }}">
                                <a href="/data/project"> Plan </a>
                            </li>
                            <li class="{{ $title == 'Data Task' ? 'active' : '' }}">
                                <a href="/data/task"> Task </a>
                            </li>
                        </ul>
                    </li>
