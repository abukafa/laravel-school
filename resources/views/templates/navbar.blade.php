            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu {{ $title == 'Data Pelajaran' || $title == 'Data Kompetensi' || $title == 'Data Nilai' || $title == 'Data Rapor' || $title == 'Data Penghargaan' ? 'active' : '' }}">
                        <a href="#academic" data-bs-toggle="collapse" aria-expanded="{{ $title == 'Data Pelajaran' || $title == 'Data Kompetensi' || $title == 'Data Nilai' || $title == 'Data Rapor' || $title == 'Data Penghargaan' ? 'true' : 'false' }}" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled {{ $title == 'Data Kursus' || $title == 'Data Pelajaran' || $title == 'Data Kompetensi' || $title == 'Data Nilai' || $title == 'Data Rapor' || $title == 'Data Penghargaan' ? 'show' : '' }}" id="academic" data-bs-parent="#accordionExample">
                            ...
                            <li class="{{ $title == 'Data Penghargaan' ? 'active' : '' }}">
                                <a href="/data/award"> Award </a>
                            </li>
                        </ul>
                    </li>
