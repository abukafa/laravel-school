                                            ...
                                            <td class="text-center">
                                                <div class="action-btns">
                                                    ...
                                                    <form action="/admin/siswa/{{ $student->id }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="submit" class="btn btn-outline-danger btn-icon btn-rounded" onclick="return confirm('Apakah anda yakin?')" {{ session('user.role') < 4 ? 'disabled' : '' }}><i class="far fa-trash-alt"></i></button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
