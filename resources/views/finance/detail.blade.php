                                        ...
                                        <div class="invoice-detail-body">
                                            ...
                                            <div class="invoice-detail-header">
                                                <form class="row g-3" action="/admin/keuangan" method="POST">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="vendor" class="form-label">Penerima</label>
                                                        <input type="text" class="form-control" name="vendor" id="vendor" value="{{ optional($items->first())->vendor }}" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="account" class="form-label">Akun</label>
                                                        <select class="form-select" name="account" id="account" required>
                                                            @if ($items->isNotEmpty())
                                                                <option>{{ $items->first()->account }}</option>
                                                            @else
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" name="remark" id="remark" value="{{ optional($items->first())->remark }}">
                                                    </div>
                                                    <div class="col-12">
                                        ...
                                        <div class="invoice-action-btn">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-md-4">
                                                    <a href="/admin/keuangan/view/{{ $invoice }}" class="btn btn-secondary btn-preview">Tampilkan</a>
                                                </div>
                                                <div class="col-xl-12 col-md-4">
                                                    <a href="/admin/keuangan" class="btn btn-success btn-download">Simpan</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
